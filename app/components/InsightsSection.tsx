      ...
      <div className="col-span-1 lg:col-span-2 bg-[#15B79E] p-6 rounded-3xl text-white">
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-sm opacity-80 mt-2 pt-4 text-white">forecasted increase in your sales closed by the end of the current month</p>
          </div>
          <div>
            <div className="flex items-center gap-2">
            ...
            <p className=" text-white text-sm opacity-80 mt-2 pt-4">forecasted increase in consultations by the end of the current month</p>
          </div>
        </div>
      </div>
    </div>
